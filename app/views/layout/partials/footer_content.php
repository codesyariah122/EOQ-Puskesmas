            ...
            <footer class="bg-white rounded-lg shadow dark:bg-gray-900 w-full max-w-screen-xl">
                <div class="container mx-auto  w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    ...
                    <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© <?=date('Y')?> <a href="/home" class="hover:underline"><?=$data['brand']?>™</a>. All Rights Reserved.</span>
                </div>
            </footer>
