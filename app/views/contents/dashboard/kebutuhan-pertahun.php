<div class="py-[30px] p-4 sm:ml-64">
        ...
        <div class="grid grid-cols-1 mb-6">
            <div class="col-span-full">
                <div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Data Kebutuhan Pertahun</h5>
                    <p class="mb-0 text-base text-gray-500 sm:text-lg dark:text-gray-400">Table Data Kebutuhan Pertahun</p>
    ...
    <div id="displaying" class="mb-4 py-0">
        ...
        <div class="grid grid-cols-1 justify-items-center">
            <?php require_once 'molecules/kebutuhan-pertahun/add-data.php' ?>
        </div>

        <div class="col-span-full">
            <!-- Search data -->
            <div class="relative py-4 mb-4">
                <?php require_once 'molecules/kebutuhan-pertahun/search-data.php' ?>
            </div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody id="kebutuhan-pertahun"></tbody>
            ...
            <div class="relative py-12">
                <?php require_once 'molecules/biaya/paging.php' ?>
            </div>
